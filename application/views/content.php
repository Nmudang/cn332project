...
<div class="wrapper row3">
	<main class="hoc container clear"> 
		...
		<ul class="nospace group btmspace-80">
			...
			<figure><a class="imgover" href="#"><img src="public/images/demo/348x261.png" alt=""></a>
				<figcaption>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay" style="background-image:url('public/images/demo/backgrounds/02.png');">
	<section id="splitfifty" class="hoc container clear">
		...
		<div class="bgded clear" style="background-image:url('public/images/demo/backgrounds/03.png');"> 
		<!-- ################################################################################################ -->
		<article>
...
<div class="wrapper row2">
	<div class="hoc container clear"> 
		...
		<li class="one_quarter first">
			<figure><a class="imgover" href="#"><img src="public/images/demo/300x300.png" alt=""></a>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded" style="background-image:url('public/images/demo/backgrounds/04.png');">
	<section id="testimonials" class="hoc clear"> 
		...
		<ul class="nospace">
			...
			<figure class="clear"><img class="circle" src="public/images/demo/60x60.png" alt="">
				<figcaption>
...
<div class="wrapper row3">
	<section class="hoc container clear"> 
		...
		<li class="one_third first">
			<article><a class="imgover" href="#"><img src="public/images/demo/348x261.png" alt=""></a>
